...
d05=np.interp(0.05, WW[:-1],df['d [mm]'][1:])
d16=np.interp(0.16, WW[:-1],df['d [mm]'][1:])
d25=np.interp(0.25, WW[:-1],df['d [mm]'][1:])
d50=np.interp(0.50, WW[:-1],df['d [mm]'][1:])
d75=np.interp(0.75, WW[:-1],df['d [mm]'][1:])
d84=np.interp(0.84, WW[:-1],df['d [mm]'][1:])
d90=np.interp(0.90, WW[:-1],df['d [mm]'][1:])1
d95=np.interp(0.95, WW[:-1],df['d [mm]'][1:])
...
ax.text(1.05, 0.575, r'$d_{90}$ [mm] ='+"{:5.2f}".format(d90), transform=ax.transAxes)
ax.text(1.05, 0.525, r'$d_{95}$ [mm] ='+"{:5.2f}".format(d95), transform=ax.transAxes)
...
ax1.text(1.05, 0.60, r'$d_{90}$ [mm] ='+"{:5.2f}".format(d90), transform=ax1.transAxes)
ax1.text(1.05, 0.56, r'$d_{95}$ [mm] ='+"{:5.2f}".format(d95), transform=ax1.transAxes)
